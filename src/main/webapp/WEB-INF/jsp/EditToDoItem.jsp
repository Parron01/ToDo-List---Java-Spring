...
<body>
    ...
    <div class="container">
        ...
        <form:form action="/editSaveToDoItem" method="post" modelAttribute="todo">
            ...
            <div class="row">
            	<div class="form-group col-md-12">
            		<label class="col-md-3" for="date">Data</label>
            		<div class="col-md-6">
            	...
            	<div class="form-group col-md-12">
            		...
            		<div class="col-md-6">
            			<form:input type="text" path="status" id="status"
            				class="form-control input-sm" value="Incompleted" />
            		</div>
            	</div>
            </div>
    ...
    <script th:inline="javascript">
                window.onload = function() {
                    ...
                    var msg = "${message}";
                    console.log(msg);
                    if (msg == "Erro ao editar") {
        				Command: toastr["error"]("Alguma coisa deu errado com editar.")
        			}
